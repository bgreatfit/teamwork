...
urlpatterns = [
     ...
     path('articles/<int:article_id>/flag', FlagCreateAPIView.as_view(), name="category-list"),
     path('gifs/<int:gif_id>/flag', FlagCreateAPIView.as_view(), name="category-list"),
     path('comments/<int:comment_id>/flag', FlagCreateAPIView.as_view(), name="category-list"),
